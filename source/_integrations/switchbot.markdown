...
- [Keypad Touch (WoKeypadTouch)](https://switch-bot.com/pages/switchbot-keypad) (currently only supports retrieving battery level and if a successful attempt was made)
